...
const TwobedRoom = () => {
  ...
  const getProducts = async () => {
    try {
      ...
      const filteredProducts = response.data.filter(room => room.category?.housetype === "Two bedroom self contained apartment");
  ...
  useEffect(() => {
    ...
    setPageTitle("TWOBEDROOM SELF-CONTAINED");
    setPageDescription(" Two-bedroom");
    ...
    <div className="w-[95vw] mx-auto flex flex-col justify-center items-center relative rounded-[50px] overflow-hidden bg-cover bg-center text-center bg-[#fff8f6] mt-10">
      <div className="text-center my-10 space-y-2 mt-30">
        ...
        <h1 className="text-4xl md:text-5xl font-bold text-gray-900 leading-snug">
          Explore our wide range of <br /> Twobedroom self contained
        </h1>
      </div>
